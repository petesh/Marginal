...
//  Marginal
//
//  Created by Pete Shanahan on 15/01/2014.
//  Copyright (c) 2014 Pete Shanahan. All rights reserved.
//

#import "PSViewController.h"

#import <DLWidgetMenu/DLWMCircularLayout.h>
#import <DLWidgetMenu/DLWMSelectionMenuAnimator.h>

@interface PSViewController () <DLWMMenuDataSource, DLWMMenuItemSource, DLWMMenuDelegate, DLWMMenuItemDelegate>
...
- (void)viewDidLoad
{
  ...
  DLWMMenu *menu = [[DLWMMenu alloc]
                    initWithMainItemView:[self viewForMainItemInMenu:nil]
                    dataSource:self
                    itemSource:self
                    delegate:self
                    itemDelegate:self
